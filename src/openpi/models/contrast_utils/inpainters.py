...
import sys
# sys.path.append('contrast_utils/inpaint_anything/lama')
sys.path.append('src/openpi/models/contrast_utils/inpaint_anything/lama')
...
_LAMA_CONFIG_PATH = 'src/openpi/models/contrast_utils/inpaint_anything/lama/configs/prediction/default.yaml'
